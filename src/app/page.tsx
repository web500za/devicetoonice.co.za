    ...
    <main>
      ...
      <section className="relative bg-black min-h-[70vh] flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <h1
            className="font-bold text-[clamp(2rem,7vw,5rem)] text-white tracking-[-0.02em] leading-[1.05]"
          ...
          <p className="text-apple-gray text-base md:text-lg mt-5 max-w-lg mx-auto leading-relaxed">
            Free nationwide delivery across South Africa. No customs. At your door in 7–10 days.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black border-t border-white/[0.06] px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-wrap justify-center gap-8 md:gap-14 text-apple-gray text-xs md:text-sm">
